    ...
    <section class="jumbotron background3 groups">
        <div class="container">
            ...
            <?php
                $receivers = $this->dispatcher->model->getStudentReceivers();
            ?>       
                                    ...
                                    <?php
                                        foreach ($receivers as $grade => $students)
                                        {
                                            ...
                                            for($i=0; $i < count($students); $i++)
                                                if($students[$i]->firstname != $this->dispatcher->Core->User->getFirstname() && $students[$i]->lastname != $this->dispatcher->Core->User->getLastname())
